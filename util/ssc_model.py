...
# X2 = np.transpose(X2)
# X3 = np.transpose(X3)
coef_path1 = '../datasets/yaleb/coef1/coef1.csv'
coef_path2 = '../datasets/yaleb/coef1/coef2.csv'
coef_path3 = '../datasets/yaleb/coef1/coef3.csv'
model1 = ssc_model(X1)
X1 = model1.computeCmat()
model2 = ssc_model(X2)
X2 = model2.computeCmat()
model3 = ssc_model(X3)
X3 = model3.computeCmat()
np.savetxt(coef_path1, X1, delimiter=",", fmt='%.4f')
np.savetxt(coef_path2, X2, delimiter=",", fmt='%.4f')
np.savetxt(coef_path3, X3, delimiter=",", fmt='%.4f')
# print(X)